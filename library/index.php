...
$book7 = new Book("Frankenstein", "Mary Shelley");
$book8 = new Book("Lolita", "Vladimir Nabokov");
$book9 = new Book("Children of Gebelawi", "Naguib Mahfouz");
$book10 = new Book("Collected Fictions", "Jorge Luis Borges");
$book11 = new Book("Mein Kampf", "Adolf Hitler");
...
$user1 = new User("Iosif", 1);
$user2 = new User("Chemberleng", 2);
